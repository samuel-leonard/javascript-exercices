...
//Au clic sur le bouton, affiche (dans la console) l'email de la personne dont le nom est "Dupont" et le prénom "Jean" dans le tableau <strong>people</strong>. Ensuite, affiche son <em>index</em> dans ce tableau.</p>
    ...
    document.getElementById('run').addEventListener("click", () => {
        ...
        people.forEach(gens => {
            if (gens.firstname === "Jean" && gens.lastname === "Dupont") {
                console.log(gens.email, people.indexOf(gens));
            }
        })
